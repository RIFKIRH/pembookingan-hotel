        ...
        >
          ...
          <div className="flex flex-col mb-4 items-start bg-white rounded-sm md:flex-row md:w-full">
            <Image
              ...
              width={500}
              height={300}
              className="object-cover w-full h-60 md:h-48 md:w-1/3 rounded-t-sm md:rounded-none md:rounded-s-sm"
              alt="image room"
            />
            <div className="flex items-center gap-1 mb-3 font-normal text-gray-700 w-full md:pl-4">
          ...
          <div className="flex items-end justify-end absolute inset-4">
            {item.Payment?.status === "unpaid" ? (
              <Link
                ...
                className="px-6 py-1 bg-orange-400 text-white
              ...
              <Link
                ...
                className="px-5 py-1 bg-orange-400 text-white
              rounded-md hover:bg-orange-500"
              >
                View Detail
              </Link>
