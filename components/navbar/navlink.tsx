...
const Navlink = () => {
  ...
  return (
    <>
        <button onClick={()=> setOpen(!open)} className='inline=flex items-center p-2 justify-center text-sm text-gray-500
        ...
        md:flex-row md:items-center md:space-x-10 md:p-0 md:mt-0 md:border-0 md:bg-white">
            ...
            <li>
                ...
                rounded-sm md:hover:bg-transparent md:p-0">Rooms</Link>
            </li>
            <li>
