      ...
      {session?.user ? (
        <div className="flex items-center justify-end md:order-2">
          ...
          <div className="flex items-center">
            <button
              onClick={() => signOut()}
              className="md:block hidden py-2 px-4 bg-gray-50 text-gray-700 hover:bg-gray-100
        ...
        <ul className="flex flex-col font-semibold text-sm uppercase p-4 mt-4 rounded-sm bg-gray-50 md:flex-row md:items-center md:space-x-10 md:p-0 md:mt-0 md:border-0 md:bg-white">
          ...
          {session ? (
            <li className="pt-2 md:pt-0">
              <button
                onClick={() => signOut}
                className="md:hidden y-2.5 px-4 bg-red-400 text-white hover:bg-red-600 rounded-sm
              cursor-pointer"
              >
                Sign Out
              </button>
