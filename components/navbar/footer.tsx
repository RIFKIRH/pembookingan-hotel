...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
      <div className="max-width-screen-xl mx-auto px-4 w-full py-10 md:py-16">
        <div className="grid md:grid-cols-3 gap-7">
          ...
          <div>
            ...
            <form action="" className="mt-5">
              ...
              <button
                className="bg-orange-400 p-3 font-bold text-white w-full text-center
      ...
      <div
        className="max-width-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center
        text-base text-gray-500"
      >
        &copy; Copyright 2025 | Rifki RH | All rights reserved.
      </div>
    </footer>
  );
};
