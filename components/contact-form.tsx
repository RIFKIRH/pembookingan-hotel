  ...
  return (
    <div className="bg-white p-8 rounded:sm shadow:sm">
      ...
      <form action={Formaction}>
        ...
        <button
          type="submit"
          className="px-10 py-4 text-center  font-semibold text-white
            w-full bg-orange-400 rounded-sm hover:bg-orange-500 cursor-pointer"
        >
          Send Message
        </button>
      </form>
