        ...
        <div className="col-span-4 bg-white p-4">
          <label
            ...
            className="flex flex-col mb-4 items-center justify-center
                aspect-video border-2 border-gray-300 border-dashed rounded-md cursor-pointer
                bg-gray-50 relative"
          >
            <div
            ...
            {!image ? (
              ...
              <Image
                ...
                className="rounded-medium
                 absoluted aspect-video object-cover"
              />
            )}
          </label>
          <div className="mb-4">
          ...
          <button
            type="submit"
            className="bg-orange-400 text-white w-full hover:bg-orange-500
          py-2.5 px-6 md:px-10 text-lg font-semibold cursor-pointer"
          >
            Save
          </button>
        </div>
